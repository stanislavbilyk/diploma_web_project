...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'diploma-web-project.onrender.com']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'myapp.context_processors.search_form_context',
            ],
        },
    },
]
...
STRIPE_PUBLIC_KEY = os.getenv('STRIPE_PUBLIC_KEY', 'your_publishable_key_here')
